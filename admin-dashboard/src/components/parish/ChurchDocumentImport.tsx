...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  { path: 'historicalDetails.founders', label: 'Founders' },
  { path: 'historicalDetails.architecturalStyle', label: 'Architectural Style' },
  { path: 'historicalDetails.heritageClassification', label: 'Heritage Classification' },
  { path: 'historicalDetails.religiousClassifications', label: 'Religious Classification' },
  { path: 'historicalDetails.historicalBackground', label: 'Historical Background' },
  { path: 'historicalDetails.architecturalFeatures', label: 'Architectural Features' },
  { path: 'historicalDetails.heritageInformation', label: 'Heritage Information' },
